...
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div style="width:410px;height:30px;float:right;"><?php echo do_shortcode('[wpdreams_ajaxsearchlite]'); ?></div>
			<div class="container clearfix">
			<div id="cjmaddedname" style="float:left;width:310px;font-family: 'Amiri',Georgia,Times ,serif!important;font-weight:bold!important;font-size:17px!important;">HISTORY of Christian Theology</div>
