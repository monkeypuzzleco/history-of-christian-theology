...
if ( ! isset( $this->main_menu_slug ) ) :
	...
	$cool_plugins_docs      = 'https://cooltimeline.com/docs?utm_source=ctp_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard';
	$cool_plugins_more_info = CTP_DEMO_URL;
?>
