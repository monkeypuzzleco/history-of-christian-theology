 ...
 *
 */
if ( ! class_exists( 'CTL_Abstract' ) ) {
  abstract class CTL_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        CTL::$css = apply_filters( "ctl_{$this->unique}_output_css", CTL::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'CTL_Field_' . $field_type;
