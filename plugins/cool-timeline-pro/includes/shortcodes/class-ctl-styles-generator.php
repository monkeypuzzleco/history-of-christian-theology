...
if ( ! class_exists( 'CTL_Styles_Generator' ) ) {
	...
	class CTL_Styles_Generator {
		...
		public static function styles_settings_vars( $settings ) {
			...
			$content_color       = isset( $settings['content_color'] ) ? $settings['content_color'] : '#666666';
			$year_lbl_text_color = isset( $settings['year_label_color'] ) ? $settings['year_label_color'] : '#ffffff';
			...
			$main_title_color    = isset( $settings['main_title_color'] ) ? $settings['main_title_color'] : '#000';
			$custom_date_color   = isset( $settings['custom_date_color'] ) ? $settings['custom_date_color'] : '';

			$ctl_date_color = '';
			if ( 'yes' === $custom_date_color ) {
				$ctl_date_color = isset( $settings['ctl_date_color'] ) ? $settings['ctl_date_color'] : '#fff';
			}

			$line_color         = isset( $settings['line_color'] ) ? $settings['line_color'] : '#025149';
			$line_filling_color = isset( $settings['line_filling_color'] ) ? $settings['line_filling_color'] : '#38aab7';
			...
			$global_styles = array(
				...
				'--ctw-cbx-des-color'      => $content_color,
				'--ctw-ybx-text-color'     => $year_lbl_text_color,
				'--ctw-cbx-title-color'    => $title_color,
				'--ctl-main-title-color'   => $main_title_color,
				'--ctw-ybx-bg'             => $year_lbl_bg_color,
				'--ctw-lbel-big-color'     => $ctl_date_color,
				'--ctw-line-bg'            => $line_color,
				'--ctw-line-filling-color' => $line_filling_color,
			);
