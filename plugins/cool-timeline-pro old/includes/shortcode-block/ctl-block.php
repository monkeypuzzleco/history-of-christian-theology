...
function ctl_pro_block_callback( $attr ) {
	...
	if ( $layout == 'horizontal' ) {
		...
		$shortcode_string = '[cool-timeline layout="%s" skin="%s" show-posts="%s" story-date="%s" date-format="%s" custom-date-format="%s"
		 ...
		 year-navigation="%s" navigation-position="%s" year-label="%s" filters="%s" filter-categories="%s" line-filling="%s" order="%s" 
...
function ctl_content_tm_block_callback( $attr ) {
	...
	if ( $layout == 'horizontal' ) {
		...
		$shortcode_string = '[cool-content-timeline layout="%s" skin="%s" show-posts="%s" story-date="%s" date-format="%s" custom-date-format="%s"
		 icons="%s" animations="%s" designs="%s" category="%s" story-content="%s" compact-ele-pos="%s" pagination="%s" year-navigation="%s" navigation-position="%s" year-label="%s" filters="%s" filter-categories="%s" line-filling="%s" order="%s" read-more="%s" content-length="%s"
