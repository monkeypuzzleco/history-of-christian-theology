...
if ( ! class_exists( 'CTL_Assets_Loader' ) ) {
	...
	class CTL_Assets_Loader {
		...
		public function ctl_common_assets() {
			...
			wp_register_style( 'ctl_common_style', CTP_PLUGIN_URL . 'includes/shortcodes/assets/css/ctl-common-styles.min.css', null, CTLPV, 'all' );
			...
			wp_register_style( 'ctl_vertical_style', CTP_PLUGIN_URL . 'includes/shortcodes/assets/css/ctl-vertical-timeline.min.css', null, CTLPV, 'all' );
			wp_register_style( 'ctl_horizontal_style', CTP_PLUGIN_URL . 'includes/shortcodes/assets/css/ctl-horizontal-timeline.min.css', null, CTLPV, 'all' );
			wp_register_script( 'ctl_common_script', CTP_PLUGIN_URL . 'includes/shortcodes/assets/js/ctl-common.js', array( 'jquery' ), CTLPV, true );
			wp_register_script( 'ctl_vertical_script', CTP_PLUGIN_URL . 'includes/shortcodes/assets/js/ctl-vertical.js', array( 'jquery' ), CTLPV, true );
			wp_register_script( 'ctl_horizontal_script', CTP_PLUGIN_URL . 'includes/shortcodes/assets/js/ctl-horizontal.js', array( 'jquery' ), CTLPV, true );
			...
			wp_register_style( 'ctl_compact_style', CTP_PLUGIN_URL . 'includes/shortcodes/assets/css/ctl-compact-style.min.css', null, CTLPV, 'all' );
			/**
			 * Frontend ajax requests.
			 */
			wp_register_script( 'ctl_load_more', CTP_PLUGIN_URL . 'includes/shortcodes/assets/js/ctl-load-more.js', array( 'jquery' ), CTLPV, true );
