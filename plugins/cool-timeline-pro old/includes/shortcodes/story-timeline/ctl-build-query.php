...
if ( ! defined( 'ABSPATH' ) ) {
	exit;
          ...
          */
          ...
          $stories_images_link =isset($ctl_options_arr['story_media_settings']['stories_images'])?$ctl_options_arr['story_media_settings']['stories_images']:'';
      ...
      if ($ctl_category) {
          ...
          if ($enable_pagination == "yes") {
            ...
            // $ordercat = $attribute['filters'] == 'yes'? 'category': 'ctl_story_timestamp';
