                ...
                vc_map(array(
                    ...
                    "params" => array(
                       ...
                       <br><a target="_blank" href="'.CTP_DEMO_URL.'">Vertical Timeline demos</a>
                          |   <a target="_blank" href="'.CTP_DEMO_URL.'">Horizontal Timeline demos</a>','cool-timeline' ),
                        ),
                        array(
                            "type" => "dropdown",
                            "class" => "",
                            ...
                            "description" =>   __('*This Options Is Not For Default Design. (<a href="'.CTP_DEMO_URL.'">Horizontal Timeline</a>','cool-timeline'),
                            'save_always' => true,
