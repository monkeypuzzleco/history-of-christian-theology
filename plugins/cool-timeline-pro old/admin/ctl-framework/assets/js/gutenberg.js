...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.ctl_gutenberg_blocks ) { return; }

  Object.values(window.ctl_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType('ctl-gutenberg-block/block-'+block.hash, {
      ...
      edit: function (props) {
        return (
          props.attributes.isPreview ?
           ...
           :
          createElement('div', {className: 'ctl-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.hash,
              className: 'is-secondary ctl-shortcode-button',
              onClick: function () {
                window.ctl_gutenberg_props = props;
              },
            }, block.button_title ),
