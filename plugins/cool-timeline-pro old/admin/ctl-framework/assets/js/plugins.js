...
(function($) {
  ...
  function CTLAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  CTLAjaxChosen.prototype.init = function() {
  ...
  CTLAjaxChosen.prototype.events = function() {
  ...
  CTLAjaxChosen.prototype.search_field_focused = function() {
  ...
  CTLAjaxChosen.prototype.search_welcome_message = function() {
  ...
  CTLAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('ctl-chosen', _this.options.data).done( function( response ) {
  ...
  CTLAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.ctl-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.CTLChosenOrder($hidden_value, true);
  ...
  $.fn.CTLAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new CTLAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, CTLAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  CTLAbstractChosenOrder = (function() {

    function CTLAbstractChosenOrder() {}

    CTLAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    CTLAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    CTLAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    CTLAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    CTLAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    CTLAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    CTLAbstractChosenOrder.CTLChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    CTLChosenOrder: function(order, force) {
      return _CTLChosenOrder.CTLChosenOrder(this, order, force);
    }
  });

  this._CTLChosenOrder = (function(_super) {
    __extends(_CTLChosenOrder, _super);

    function _CTLChosenOrder() {
      _ref = _CTLChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _CTLChosenOrder.relAttributeName = 'data-option-array-index';

    _CTLChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _CTLChosenOrder.getDOMElement = function(element) {
    ...
    _CTLChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _CTLChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _CTLChosenOrder;

  })(CTLAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('ctl-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Ctl: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Ctl: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectCTL = FormSerializer.serializeObject;
    $.fn.serializeJSONCTL   = FormSerializer.serializeJSON;
  }
