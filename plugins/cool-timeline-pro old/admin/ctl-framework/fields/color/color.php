 ...
 *
 */
if ( ! class_exists( 'CTL_Field_color' ) ) {
  class CTL_Field_color extends CTL_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="ctl-color"'. $default_attr . $this->field_attributes() .'/>';
