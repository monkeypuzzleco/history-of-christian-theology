...
jq(function($) {
	...
	function send_new_css(name, value) {
		...
		list_css['keyterm_color'] = $('#cmb2-metabox-glossary_options2 .cmb2-id-keyterm-color .wp-color-result').css('background-color');
		list_css['keyterm_background'] = $('#cmb2-metabox-glossary_options2 .cmb2-id-keyterm-background .wp-color-result').css('background-color');
		list_css['keyterm_size'] = $('#cmb2-metabox-glossary_options2 #keyterm_size').val();
		list_css['link_keyterm_color'] = $('#cmb2-metabox-glossary_options2 .cmb2-id-link-keyterm-color .wp-color-result').css('background-color');
	...
	$("#gl-sticky").stick_in_parent({offset_top:40, bottoming:false, sticky_class:'is_stick'});
});
