...
class Enqueue extends Engine\Base {
	...
	public function enqueue_admin_scripts() {
		\wp_enqueue_script( GT_SETTINGS . '-admin-script', \plugins_url( 'assets/js/admin.js', GT_PLUGIN_ABSOLUTE ), array( 'jquery' ), GT_VERSION, false );
		...
		\wp_enqueue_script( GT_SETTINGS . '-admin-tabs-script', \plugins_url( 'assets/js/tabs.js', GT_PLUGIN_ABSOLUTE ), array( 'jquery', 'jquery-ui-tabs' ), GT_VERSION, false );
