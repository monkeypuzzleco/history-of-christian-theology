...
class CMB extends Engine\Base {
	...
	public function initialize() {
		...
		\add_action( 'cmb2_save_options-page_fields', array( $this, 'permalink_alert' ), 9999, 4 );

		if ( \gt_fs()->is_plan__premium_only( 'professional' ) ) {
			\add_action( 'cmb2_save_options-page_fields', array( $this, 'cache_alert__premium_only' ), 9999, 4 );
